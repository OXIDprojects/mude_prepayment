...
'ACCOUNT_NEWSLETTER_MESSAGE'                      => "<br><br>Sie können den Newsletter jederzeit kostenlos abbestellen.",
...
'ACCOUNT_USER_COMPANY2'                           => "Firma / PostNummer (bei Packstation):",
'ACCOUNT_USER_STREETANDSTREETNO2'                 => "Straße, Hausnummer / Packstation, Nummer:<br>(Bitte anstatt Straße \"Packstation\" eintragen)",
...
'BASKET_ARTICLENOTONSTOCK'                        => "Dieser Artikel ist nicht auf Lager.",
...
'CONTACT_VERIFICATIONCODE_ENTRY'                  => "Prüfcode:",
...
'DETAILS_NOTONSTOCK'                              => "Dieser Artikel ist nicht auf Lager.",
'DETAILS_AVAILABLEON'                             => "Lieferbar ab",
'DETAILS_LOWSTOCK'                                => "Nur noch wenige Exemplare!",
...
'DETAILS_PRICEALARM'                              => "Preisalarm!",
'DETAILS_LABEL'                                   => "Beschriftung:",
'DETAILS_PRICEALARM2'                             => "Preisalarm!",
'DETAILS_REMOVEFROMCOMPARELIST'                   => "Artikel aus Vergleich entfernen",
'DETAILS_COMPARE'                                 => "Artikel vergleichen",
'DETAILS_RECOMMEND'                               => "Einem Freund empfehlen",
...
'DETAILS_LOGGINTOWRITEREVIEW'                     => 'Sie müssen <span class="important">angemeldet</span> sein, um eine Bewertung schreiben zu können.',
...
'DETAILS_LASTSEENPRODUCTS'                        => "Zuletzt gesehen",
'DETAILS_TOPPRODUCTS'                             => "Unsere Topseller",
...
'INC_NEWBASKETITEM_STOCKERROR1'                   =>"Dieser Artikel ist nicht.",
...
'INC_NOTICE_PRODUCT_ITEM_REMOVEFROMCOMPARELIST'   =>"aus Vergleich entfernen",
...
'INC_PRODUCTITEM_REMOVEFROMCOMPARELIST'           =>"Artikel aus Vergleich entfernen",
'INC_PRODUCTITEM_COMPARE'                         =>"Artikel vergleichen",
...
'INC_PRODUCTITEM_REMOVEFROMCOMPARELIST2'          =>"Artikel aus Vergleich entfernen",
'INC_PRODUCTITEM_COMPARE2'                        =>"Artikel vergleichen",
'INC_PRODUCTITEM_ADDTOCARD2'                      =>"in den Warenkorb",
'INC_PRODUCTITEM_ARTNOMBER3'                      =>"Art.Nr.:",
'INC_PRODUCTITEM_MOREINFO3'                       =>"mehr Info",
'INC_PRODUCTITEM_REMOVEFROMCOMPARELIST3'          =>"Artikel aus Vergleich entfernen",
'INC_PRODUCTITEM_COMPARE3'                        =>"Artikel vergleichen",
...
'INC_RECOMM_PRODUCT_ITEM_REMOVEFROMCOMPARELIST'   =>"aus Vergleich entfernen",
...
'INC_RIGHTITEM_TOPOFTHESHOP'                      =>"Unsere Top 5",
'INC_RIGHTITEM_BARGAIN'                           =>"Schnäppchen",
'INC_RIGHTITEM_ACCESSORIES'                       =>"Dazu passt",
'INC_RIGHTITEM_SIMILARPRODUCTS'                   =>"Das könnte Ihnen auch gefallen",
'INC_RIGHTITEM_RECOMMLIST'                        =>"Lieblingslisten",
'INC_RIGHTITEM_SEARCHFORLISTS'                    =>"Suche nach weiteren Listen:",
'INC_RIGHTITEM_HAVEPOUSEEN'                       =>"Das könnte Ihnen auch gefallen",
'INC_RIGHTITEM_CUSTOMERWHO'                       =>"Andere kauften",
'INC_RIGHTLIST_ARTNOMBER'                         =>"Art.Nr.:",
'INC_RIGHTLIST_ARTWEIGHT'                         =>"Gewicht:",
'INC_RIGHTLIST_ARTWEIGHT2'                        =>"kg",
'INC_RIGHTLIST_MOREINFO'                          =>"mehr Info",
'INC_RIGHTLIST_REMOVEFROMCOMPARELIST'             =>"Artikel aus Vergleich entfernen",
'INC_RIGHTLIST_COMPARE'                           =>"Artikel vergleichen",
...
'INC_SEARCH_PRODUCT_ITEM_REMOVEFROMCOMPARELIST'   =>"Artikel aus Vergleich entfernen",
'INC_SEARCH_PRODUCT_ITEM_COMPARE'                 =>"Artikel vergleichen",
...
'INC_VENDORLEFTITEM_BYMARK'                       =>"Marke",
'LINKS_TITLE'                                     => "Partner",
'LINKS_LINKS'                                     => "Partner",
...
'ORDER_VERIFYYOURINPUT'                           => "Hier können Sie Ihre Bestellung nochmal kontrollieren.",
...
'ORDER_MODIFY'                                    => "ändern",
'ORDER_ITEMMUSTBEBACKORDERED'                     => "Dieser Artikel ist nicht auf Lager.",
...
'REGISTER_SUCCESS_WELCOME'                        => "Herzlich willkommen als Mitglied im Meine Strümpfe Shop!",
...
'REGISTER_DIFFERENTSHIPPINGADDRESS'               => "Hier klicken, um an eine andere Adresse (auch Packstation) zu liefern",
...
'REGISTER_COMPANY2'                               => "Firma / PostNummer (bei Packstation):",
'REGISTER_STREET2'                                => "Straße, Hausnummer / Packstation, Nummer:<br>(Bitte anstatt Straße \"Packstation\" eintragen)",
...
'START_LONGRUNNINGHITS'                           => "Unsere Topseller zum Schnäppchenpreis",
'START_JUSTARRIVED'                               => "Zufällige Strümpfe, Strumpfhosen, Leggings und Socken",
...
'USER_BIRTHDAYMESSAGE'                            => "Verraten Sie uns Ihr Geburtsdatum,<br>damit wir Sie überraschen können.",
...
'USER_DIFFERENTSHIPPINGADDRESS'                   => "Hier klicken, um an eine andere Adresse (auch Packstation) zu liefern",
'USER_NOTE'                                       => "Hinweis:",
...
'USER_COMPANY2'                                   => "Firma / PostNummer (bei Packstation):",
'USER_STREET2'                                    => "Straße, Hausnummer / Packstation, Nummer:<br>(Bitte anstatt Straße \"Packstation\" eintragen)",
...
'EXCEPTION_OUTOFSTOCK_OUTOFSTOCK'                 => 'Dieser Artikel ist nicht mehr in ausreichender Menge verfügbar! Verfügbar:',
...
'INVITE_SENDEREMAIL'                              => "E-Mail des Absenders:",
...
'NFQ_NOTIFY_BUTTON_TITLE_SHORT'                   => 'Benachrichtigen sie mich!',
'INC_ADDITIONAL_WOMEN'                            => 'Für Damen',
'INC_ADDITIONAL_MEN'                              => 'Für Herren',
'INC_ADDITIONAL_NEWSLETTER'                       => '<br>Die neuesten Artikel, Aktionen und Updates direkt per Mail!<br><br>Tragen Sie sich in unseren kostenlosen Newsletter ein.',
'INC_ADDITIONAL_SOCIAL'                           => 'Social Media',
'BASKET_ARTICLES'                                 => 'Teile',
'TO_BASKET_TITLE'                                 => 'Zum Warenkorb - Kasse',
'INC_TABBOX_CUSTOMERWHO'                          => 'Andere kauften',
'INC_TABBOX_COMMENT'                              => 'Bewertungen',
'INC_TABBOX_ACCESSOIRES'                          => 'Dazu passt auch',
'INC_TABBOX_SIMILAR'                              => 'Kennen Sie schon',
'INC_SELECTOR_LABEL'                              => 'Bitte wählen Sie Größe und Farbe:',
'INC_PRODUCTITEM_PREORDER'                        => 'Ausverkauft',
'INC_PRODUCTITEM_PREORDER1'                       => 'Ausverkauft',
'INC_LIST_FILTER_ALL'                           	=> '- alle Marken -',
'SECUPAY_CESSION_TEXT_DEBIT_FORMAL'               => "<p style='font-size:11px;' align='justify'>Sehr geehrte Damen und Herren,<br/><br/>da Sie sich f&uuml;r die Zahlungsart 'Lastschrift' entschieden haben, bitten wir um Verst&auml;ndnis, dass wir das hierdurch f&uuml;r uns bestehende Einziehungsrisiko gerne mit einem hierauf spezialisierten Partner teilen m&ouml;chten.<br/>Wir weisen Sie daher hiermit darauf hin, dass wir die uns zustehende Entgeltforderung in vollem Umfang und unwiderruflich an das nachfolgende Unternehmen abtreten werden:</p><br/><p style='font-size:11px;'>secupay AG<br/>Goethestr. 6<br/>01896 Pulsnitz<br/><br/><p style='font-size:11px;' align='justify'>Die Abtretung steht unter der aufschiebenden Bedingung, dass secupay die Abtretung annimmt. Die secupay AG wird daher den uns zustehenden Betrag von Ihrem Konto per Lastschrift einziehen.</p>",
'SECUPAY_CESSION_TEXT_DEBIT'                      => "<p align='justify'>Hallo,<br/><br/>da Du dich f&uuml;r die Zahlungsart 'Lastschrift' entschieden hast, bitten wir um Verst&auml;ndnis, dass wir das hierdurch f&uuml;r uns bestehende Einziehungsrisiko gerne mit einem hierauf spezialisierten Partner teilen m&ouml;chten.<br/> Wir weisen Dich daher hiermit darauf hin, dass wir die uns zustehende Entgeltforderung in vollem Umfang und unwiderruflich an das nachfolgende Unternehmen abtreten werden:</p><br/><p>secupay AG<br/>Goethestr. 6<br/>01896 Pulsnitz<br/><br/>Die Abtretung steht unter der aufschiebenden Bedingung, dass secupay die Abtretung annimmt. Die secupay AG wird daher den uns zustehenden Betrag von Deinem Konto per Lastschrift einziehen.",
'SECUPAY_CESSION_TEXT_CREDITCARD_FORMAL'          => "da Sie sich f&uuml;r die Zahlungsart 'Kreditkarte' entschieden haben, bitten wir um Verst&auml;ndnis, dass wir das hierdurch f&uuml;r uns bestehende Einziehungsrisiko gerne mit einem hierauf spezialisierten Partner teilen m&ouml;chten. Wir weisen Sie daher hiermit darauf hin, dass wir die uns zustehende Entgeltforderung in vollem Umfang und unwiderruflich an das nachfolgende Unternehmen abtreten werden:<br/><p>secupay AG<br/>Goethestr. 6<br/>01896 Pulsnitz<br/><br/>Die Abtretung steht unter der aufschiebenden Bedingung, dass secupay die Abtretung annimmt. Die secupay AG wird daher den uns zustehenden Betrag von Ihrer Kreditkarte einziehen.",
'SECUPAY_CESSION_TEXT_CREDITCARD'                 => "da Du dich f&uuml;r die Zahlungsart 'Kreditkarte' entschieden hast, bitten wir um Verst&auml;ndnis, dass wir das hierdurch f&uuml;r uns bestehende Einziehungsrisiko gerne mit einem hierauf spezialisierten Partner teilen m&ouml;chten. Wir weisen Dich daher hiermit darauf hin, dass wir die uns zustehende Entgeltforderung in vollem Umfang und unwiderruflich an das nachfolgende Unternehmen abtreten werden:<br/><p>secupay AG<br/>Goethestr. 6<br/>01896 Pulsnitz<br/><br/>Die Abtretung steht unter der aufschiebenden Bedingung, dass secupay die Abtretung annimmt. Die secupay AG wird daher den uns zustehenden Betrag von Deiner Kreditkarte einziehen.",
'SECUPAY_KAEUFERSCHUTZ_TEXT'		                  => "mit secupay K&auml;uferschutz",
'SECUPAY_LIEFERADRESSE_TEXT'		                  => 'Achtung: Der Versand erfolgt auschlie&szlig;lich an die angegebene Rechnungsadresse.',
'PAYPAL_DESCRIPTION'                              => 'Bei Auswahl der Zahlungsart PayPal werden Sie im nächsten Schritt zu PayPal weitergeleitet. Dort können Sie sich in Ihr PayPal-Konto einloggen oder ein neues PayPal-Konto eröffnen und die Zahlung autorisieren. Sobald Sie Ihre Daten für die Zahlung bestätigt haben, werden Sie automatisch wieder zurück in den Shop geleitet, um die Bestellung abzuschließen. Erst dann wird die Zahlung ausgeführt. Sie werden nach Bestätigung unserer AGB im letzten Bestellschritt an Sofortüberweisung weitergeleitet und können dort Ihre Zahlung vornehmen.',
'SOFORTUEBERWEISUNG_DESCRIPTION'                  => 'Sofortüberweisung.de ist ein Direkt-Überweisungsverfahren auf dem hohen Sicherheitsstandard von Online Banking und TÜV geprüften Datenschutz. Sie müssen sich bei sofortüberweisung.de nicht registrieren, denn über das gesicherte, vom Händler nicht zugängliche, Sofortüberweisung.de-Zahlungsformular, stellt Sofortüberweisung.de automatisch und in Echtzeit eine Überweisung in Ihrem Online-Banking-Konto ein. Der Kaufbetrag wird sofort und direkt an das Bankkonto des Händlers überwiesen. So können wir Ihre Bestellung sofort verschicken.',
'SECUPAY_DESCRIPTION'                             => 'Mit dem Käuferschutz von secupay sind Sie auf der sicheren Seite. Wenn Sie Ihre Bestellung per Kreditkarte bezahlen, sichert Sie die secupay AG bis zu 6 Wochen für den Fall des berechtigten Widerspruchs oder bei Nicht- bzw. Falschlieferung ab. Sollte der Onlineshop die Rückzahlung verweigern oder nicht in der Lage sein diese zu leisten, erhalten Sie Ihr Geld von der secupay AG zurück. Diesen Service erhalten Sie automatisch indem Sie per Kreditkarte bezahlen.',
'VORAUSKASSE_DESCRIPTION'                         => 'Nach dem Bestellabschluss erhalten Sie unsere Bankverbindung mit der Bestellbestätigung per E-Mail. Überweisen Sie bitte den Rechnungsbetrag auf das entsprechende Konto. Bitte beachten Sie, dass sich die Lieferzeit bei Zahlung per Vorauskasse verzögert, da wir erst den Zahlungseingang überprüfen müssen.',
'SOCIALMEDIA_START'   			                      => 'Werden Sie ein Fan unseres Shops und profitieren Sie von exklusiven Shoppingvorteilen! Wir freuen uns auf Sie :-)',
'TRUSTEDSHOPS_LEFT'   			                      => 'Kundenbewertungen',
'FACEBOOK_ENABLETEXT'                             => 'Um die Facebook Plugins zu Aktivieren, klicken Sie bitte auf diesen Button.',
'EMAIL_ORDER_CUST_HTML_ADVANCE_TEXT'              => 'Bitte überweisen Sie den Rechnungsbetrag an folgende Bankverbindung:',
'PICAB_PAYMENT_CABTEXT'                         	=> "Einfache und sichere Zahlung per Kreditkarte, Lastschrift,<br />Online&uuml;berweisung oder Kontoaufladung", 
'PICAB_PAYMENT_MORELINK_LANGCODE'               	=> "DE/de", 
'PICAB_PAYMENT_MORELINK'                        	=> "Mehr Infos", 
'PICAB_PAYMENT_MORELINK'                        	=> "Mehr Infos", 
'PICAB_ERROR__ITEM1'		                        	=> "Transaktion fehlgeschlagen", 
'PICAB_ERROR__ITEM2'		                        	=> "Ihre Kauftransaktion konnte leider nicht erfolgreich abgeschlossen werden.<br />Bitte versuchen Sie es zu einem späteren Zeitpunkt erneut oder<br />kontaktieren Sie Ihren Shopbetreiber.", 
'PICAB_ERROR__ITEM3'		                        	=> "Aufgetretener Fehler"
);
